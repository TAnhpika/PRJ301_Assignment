...
public class SlotReservation {
    ...
    // Backward compatibility with appointmentId
    public int getAppointmentId() {
        return reservationId;
    }

    public void setAppointmentId(int appointmentId) {
        this.reservationId = appointmentId;
    }
    ...
    public String toString() {
        return String.format("SlotReservation{reservationId=%d, doctorId=%d, workDate=%s, slotId=%d, " +
                "patientId=%d, status='%s', payosOrderId='%s', remaining='%s'}",
                reservationId, doctorId, workDate, slotId, patientId,
