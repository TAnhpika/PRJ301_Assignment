...
public class DoctorDAO {
    ...
    public static List<Doctors> filterDoctors(String keyword, String specialty) {
        ...
        String sql = "SELECT d.*, u.email FROM Doctors d JOIN users u ON d.user_id = u.user_id WHERE 1=1";
     ...
     */
    public static String createPaymentLink(int doctorId, int appointmentId, int patientId, BigDecimal amount)
            throws SQLException {
     ...
     */
    public static List<Map<String, Object>> getDoctorPayments(int doctorId, String fromDate, String toDate)
            throws SQLException {
     ...
     */
    public static boolean createDoctorScheduleTemplate(int doctorId, String templateName, String scheduleData)
            throws SQLException {
     ...
     */
    public static boolean applyScheduleTemplate(int doctorId, int templateId, String startDate, String endDate)
            throws SQLException {
        ...
        try (Connection conn = DBContext.getConnection();
                PreparedStatement st = conn.prepareStatement(getTemplateSql)) {
    ...
    public static Map<String, Object> getDoctorMonthlyStats(int doctorId, int month, int year) throws SQLException {
        ...
        try (Connection conn = DBContext.getConnection();
                PreparedStatement st1 = conn.prepareStatement(totalSql);
            ...
            try (ResultSet rs1 = st1.executeQuery()) {
                if (rs1.next())
                    stats.put("totalAppointments", rs1.getInt("total"));
            }

            try (ResultSet rs2 = st2.executeQuery()) {
                if (rs2.next())
                    stats.put("completedAppointments", rs2.getInt("completed"));
            }

            try (ResultSet rs3 = st3.executeQuery()) {
                if (rs3.next())
                    stats.put("cancelledAppointments", rs3.getInt("cancelled"));
            }

            try (ResultSet rs4 = st4.executeQuery()) {
                if (rs4.next())
                    stats.put("revenue", rs4.getBigDecimal("revenue"));
            }
        }
     ...
     */
    public static List<Map<String, Object>> getTopServicesByDoctor(int doctorId, String fromDate, String toDate,
     ...
     */
    public static List<String> checkScheduleConflicts(int doctorId, String startDate, String endDate)
            throws SQLException {
     ...
     */
    public static boolean sendNotificationToPatients(int doctorId, String message, String notificationType)
            throws SQLException {
        ...
        try (Connection conn = DBContext.getConnection();
                PreparedStatement st = conn.prepareStatement(getPatientsSql)) {
            st.setInt(1, doctorId);
        ...
        try (Connection conn = DBContext.getConnection();
                PreparedStatement st = conn.prepareStatement(insertNotificationSql)) {
     ...
     */
    public static boolean createMedicalReport(int appointmentId, int doctorId, String diagnosis, String treatment,
     ...
     */
    public static boolean updateMedicalReport(int reportId, int doctorId, String diagnosis, String treatment,
            String notes) throws SQLException {
     ...
     */
    public static List<Map<String, Object>> getDoctorMedicalReports(int doctorId, String fromDate, String toDate)
            throws SQLException {
     ...
     */
    public static boolean createPrescription(int reportId, int doctorId, List<Map<String, Object>> medicines)
            throws SQLException {
     ...
     */
    public static List<Map<String, Object>> getDoctorPrescriptions(int doctorId, String fromDate, String toDate)
            throws SQLException {
    ...
    public static Map<String, Object> getDoctorPerformanceMetrics(int doctorId, String period) throws SQLException {
        ...
        String completionSql = "SELECT " +
                ...
                + dateCondition.replace("appointment_date", "appointment_date");
        ...
        try (Connection conn = DBContext.getConnection();
                PreparedStatement st1 = conn.prepareStatement(satisfactionSql);
     ...
     */
    public static Map<String, Object> generateDoctorComprehensiveReport(int doctorId, String fromDate, String toDate)
            throws SQLException {
        ResultSet rs = null;
        Map<String, Object> report = new HashMap<>();
     ...
     */
    public static boolean syncDoctorWithExternalSystem(int doctorId, String systemName, Map<String, Object> syncData)
            throws SQLException {
     ...
     */
    public static Map<String, Object> generateDoctorRevenueReport(int doctorId, String fromDate, String toDate,
        ...
        try (Connection conn = DBContext.getConnection(); PreparedStatement st = conn.prepareStatement(sql)) {
            ...
            try (ResultSet rs = st.executeQuery()) {
                ...
                report.put("summaryStats", Map.of(
                        ...
                        totalAppointments > 0
                                ? totalRevenue.divide(BigDecimal.valueOf(totalAppointments), 2,
     ...
     */
    public static Map<String, Object> analyzeDoctorPatientDemographics(int doctorId, String fromDate, String toDate)
            throws SQLException {
        ...
        try (Connection conn = DBContext.getConnection();
                PreparedStatement st1 = conn.prepareStatement(ageSql);
    ...
    public static Map<String, Object> predictDoctorWorkload(int doctorId, int predictDays) throws SQLException {
        ...
        try (Connection conn = DBContext.getConnection();
                PreparedStatement st1 = conn.prepareStatement(historicalSql);
    ...
    public static boolean cleanupOldDoctorData(int doctorId, int retentionMonths) throws SQLException {
        ...
        try (Connection conn = DBContext.getConnection();
                PreparedStatement st1 = conn.prepareStatement(archiveSql);
    ...
    private static List<Map<String, Object>> getDoctorSchedules(int doctorId, String fromDate, String toDate)
            throws SQLException {
    ...
    private static List<Map<String, Object>> getDoctorAppointments(int doctorId, String fromDate, String toDate)
            throws SQLException {
    ...
    public static MedicalReport getPrescriptionsByReportId(int reportId) throws SQLException {
        ...
        try (Connection conn = DBContext.getConnection(); PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                ...
                try {
                    report.setReexamLan2(rs.getBoolean("is_reexam_lan_2"));
                } catch (SQLException e) {
                    report.setReexamLan2(false);
                }
                return report;
            }
        }
     ...
     */
    public static int insertMedicalReport(int appointmentId, long doctorId, int patientId,
            String diagnosis, String treatmentPlan, String note, String sign, boolean isReexamLan2)
            throws SQLException {
