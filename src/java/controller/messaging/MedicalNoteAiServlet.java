                    ...
                    try {
                        ...
                        if (medicine != null) {
                            ...
                            if (i < quantities.length && quantities[i] != null && !quantities[i].trim().isEmpty()) {
                                prompt.append(" - Số lượng: ").append(quantities[i]).append(" ")
                                        .append(medicine.getUnit());
                            }

                            if (usages != null && i < usages.length && usages[i] != null
                                    && !usages[i].trim().isEmpty()) {
                                prompt.append(" - Cách dùng: ").append(usages[i]);
                            }
                            prompt.append("\n");
                        } else {
                            prompt.append("  - Thuốc ID: ").append(medicineIds[i])
                                    .append(" (không tìm thấy thông tin)\n");
                        }
