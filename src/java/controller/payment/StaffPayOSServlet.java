    ...
    throws ServletException, IOException {
        ...
        if ("payos".equals(paymentMethod)) {
            ...
            try {
                ...
                String qrCode = util.PayOSUtil.createPayOSPaymentRequest(bill, "Bán thuốc: " + medicineName);
                ...
                request.getRequestDispatcher("/view/jsp/admin/bill_qr.jsp").forward(request, response);
                return;
            } catch (Exception e) {
                e.printStackTrace();
            }
