...
public class LoginServlet extends HttpServlet {
        ...
        if (userEmail != null) {
            ...
            if (user == null) {
                ...
                if (userId > 0) {
                    ...
                    response.sendRedirect(request.getContextPath() + "/view/jsp/auth/login.jsp?error=system_error");
                    return;
                }
            }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null) {
            ...
            response.sendRedirect(request.getContextPath() + "/view/jsp/auth/login.jsp?error=1");
        }
    }
