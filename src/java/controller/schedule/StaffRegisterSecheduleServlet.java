...
public class StaffRegisterSecheduleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ColoredLogger.logSuccess("StaffRegisterSecheduleServlet",
                    "Staff found: " + staff.getStaffId() + ", Type: " + staff.getEmploymentType());
            ...
            if ("fulltime".equals(staff.getEmploymentType())) {
                ...
                int usedDays = scheduleDAO.getApprovedLeaveDaysInMonth((int) staff.getStaffId(), currentMonth,
                        currentYear);
                ...
                java.util.List<model.StaffSchedule> scheduleRequests = scheduleDAO
                        .getStaffSchedulesByMonth((int) staff.getStaffId(), currentMonth, currentYear);
                request.setAttribute("scheduleRequests", scheduleRequests);

                ColoredLogger.logInfo("StaffRegisterSecheduleServlet",
                        "Set leave data: used=" + usedDays + ", max=" + maxDays + ", remaining=" + remainingDays);
            } else {
