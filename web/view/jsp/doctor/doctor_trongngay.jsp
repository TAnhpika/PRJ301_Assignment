            ...
            <div class="cards">
                ...
                <div class="cards-column">
                    ...
                    <div class="single-card">
                        ...
                        <div class="info">
                            <img src="${pageContext.request.contextPath}/view/assets/img/default-avatar.png" alt="avatar" style="width: 64px; height: 64px; object-fit: cover;" onerror="this.src='${pageContext.request.contextPath}/view/assets/img/default-avatar.png'">
