                            ...
                            <c:forEach var="i" begin="1" end="6">
                                <div class="patient-card-container">
                                    <div class="patient-info">
                                        <img class="patient-avatar" src="${pageContext.request.contextPath}/view/assets/img/default-avatar.png" alt="avatar" onerror="this.src='${pageContext.request.contextPath}/view/assets/img/default-avatar.png'"/>
