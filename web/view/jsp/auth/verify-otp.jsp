...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/view/assets/css/all.min.css" rel="stylesheet">
    <style>
        :root {
...
<body>
    <div class="main-container">
        <!-- Back Link -->
        <a href="${pageContext.request.contextPath}/ResetPasswordServlet?action=forgot-password" class="back-link">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="resend-section">
                    ...
                    <a href="${pageContext.request.contextPath}/ResetPasswordServlet?action=forgot-password" class="btn btn-outline-primary">
