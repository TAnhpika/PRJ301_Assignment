                                                            ...
                                                            <div class="col-md-6 col-lg-4 doctor-item"
                                                                ...
                                                                <div class="doctor-card">
                                                                    <div class="d-flex align-items-center mb-3">
                                                                         <img src="<%= doctor.getAvatar() != null && !doctor.getAvatar().isEmpty() ? doctor.getAvatar() : request.getContextPath() + "/view/assets/img/default-user-avatar.png" %>"
                                                                         class="doctor-avatar me-3" alt="Doctor Avatar"
                                                                         onerror="this.onerror=null;this.src='<%= request.getContextPath() %>/view/assets/img/default-user-avatar.png';">
                                                                        <div>
                                                                            <h6 class="mb-1">
                                                                                <%= doctor.getFullName() %>
                                                                            </h6>
